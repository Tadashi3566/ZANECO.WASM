...
public abstract class ContactTableContext<TEntity, TId, TRequest>
{
    /// <summary>
    ...
    public ContactServerTableContext<TEntity, TId, TRequest>? ServerContext => this as ContactServerTableContext<TEntity, TId, TRequest>;
