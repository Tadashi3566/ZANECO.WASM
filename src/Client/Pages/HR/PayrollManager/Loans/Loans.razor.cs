    ...
    protected override void OnInitialized() =>
        Context = new(
            ...
            fields: new()
            {
                ...
                new(data => data.DateReleased, "Released", "DateReleased", typeof(DateTime)),
                new(data => data.DateStart, "Start", "DateStart", typeof(DateTime)),
                new(data => data.Months, "Months", "Months"),
                new(data => data.DateEnd, "End", "DateEnd", typeof(DateTime)),
