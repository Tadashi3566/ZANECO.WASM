...
namespace ZANECO.WASM.Client.Pages.HR.EmployeeManager.Employers;
    ...
    protected override void OnInitialized() =>
        Context = new(
            ...
            fields: new()
            {
                ...
                new(data => data.StartDate, "StartDate", "StartDate", typeof(DateTime)),
                new(data => data.EndDate, "EndDate", "EndDate", typeof(DateTime)),
