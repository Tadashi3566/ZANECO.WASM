...
public class AutocompleteMiddleName : MudAutocomplete<string>
{
    [Inject]
    ...
    private async Task<IEnumerable<string>> SearchText(string value)
    {
        ...
        {
            PageSize = 10,
            AdvancedSearch = new() { Fields = new[] { "middlename" }, Keyword = value }
        };
        ...
        return _list.Select(x => x.MiddleName).Distinct();
    }
}